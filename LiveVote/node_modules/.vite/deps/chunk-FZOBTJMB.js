...
var autoPlacement = function(options) {
  ...
  return {
    ...
    async fn(state) {
      ...
      const placementsSortedByMostSpace = allOverflows.map((d13) => {
        const alignment2 = getAlignment(d13.placement);
        return [d13.placement, alignment2 && crossAxis ? (
          // Check along the mainAxis and main crossAxis side.
          d13.overflows.slice(0, 2).reduce((acc, v4) => acc + v4, 0)
        ) : (
          // Check only the mainAxis.
          d13.overflows[0]
        ), d13.overflows];
      }).sort((a20, b9) => a20[1] - b9[1]);
      const placementsThatFitOnEachSide = placementsSortedByMostSpace.filter((d13) => d13[2].slice(
        0,
        // Aligned placements should not check their opposite crossAxis
        // side.
        getAlignment(d13[0]) ? 2 : 3
      ).every((v4) => v4 <= 0));
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-FZOBTJMB.js.map
