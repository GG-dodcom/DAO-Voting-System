import {
  require_encode_utf8
} from "./chunk-47FCCYBK.js";
import {
  require_dijkstra
} from "./chunk-DBQCCCBW.js";
import {
  BigNumber,
  proxyMap,
  require_dayjs_min,
...
var W3mFrameProvider = class {
  ...
  async appEvent(event) {
    ...
    if (shouldCheckForTimeout && this.onTimeout) {
      timer = setTimeout(this.onTimeout, 15e3);
    }
...
var ConnectorController = {
  ...
  setConnectors(connectors) {
    ...
    state8.allConnectors = [...state8.connectors, ...newConnectors];
...
var SwapController = {
  ...
  hasInsufficientToken(sourceTokenAmount, sourceTokenAddress) {
    ...
    const insufficientNetworkTokenForGas = SwapCalculationUtil.isInsufficientNetworkTokenForGas(state11.networkBalanceInUSD, state11.gasPriceInUSD);
...
WuiGrid.styles = [resetStyles, styles_default74];
__decorate74([
  property()
...
WuiSeparator.styles = [resetStyles, styles_default75];
__decorate75([
  property()
], WuiSeparator.prototype, "text", void 0);
WuiSeparator = __decorate75([
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2KLWC2KK.js.map
