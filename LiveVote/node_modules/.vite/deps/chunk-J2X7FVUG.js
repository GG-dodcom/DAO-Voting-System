...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_3) try {
      if (f3 = 1, y6 && (t = op[0] & 2 ? y6["return"] : op[0] ? y6["throw"] || ((t = y6["return"]) && t.call(y6), 0) : y6.next) && !(t = t.call(y6, op[1])).done) return t;
...
function __values(o5) {
  var s2 = typeof Symbol === "function" && Symbol.iterator, m2 = s2 && o5[s2], i3 = 0;
...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  function verb(n4) {
    if (g3[n4]) i3[n4] = function(v4) {
      return new Promise(function(a4, b3) {
        q2.push([n4, v4, a4, b3]) > 1 || resume(n4, v4);
      });
    };
  }
  ...
  function settle(f3, v4) {
    if (f3(v4), q2.shift(), q2.length) resume(q2[0][0], q2[0][1]);
  }
}
function __asyncDelegator(o5) {
  ...
  function verb(n4, f3) {
    i3[n4] = o5[n4] ? function(v4) {
      return (p3 = !p3) ? { value: __await(o5[n4](v4)), done: n4 === "return" } : f3 ? f3(v4) : v4;
    } : f3;
  }
}
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-J2X7FVUG.js.map
