...
import {
  ...
  setColorTheme,
  setThemeVariables
} from "./chunk-2KLWC2KK.js";
import {
  subscribeKey
} from "./chunk-MX72ML3O.js";
import {
  proxy,
  ref,
  subscribe
} from "./chunk-IOB7GAQF.js";
import {
  dr
} from "./chunk-J2X7FVUG.js";
import {
  A,
  k
} from "./chunk-2J5OESMT.js";
...
var CaipNetworksUtil = {
  ...
  getRpcUrl(caipNetwork, caipNetworkId, projectId) {
    var _a2, _b2, _c;
    const defaultRpcUrl = (_c = (_b2 = (_a2 = caipNetwork.rpcUrls) == null ? void 0 : _a2.default) == null ? void 0 : _b2.http) == null ? void 0 : _c[0];
...
var UniversalAdapterClient = class {
  constructor(options) {
    ...
    this.networkControllerClient = {
      ...
      getApprovedCaipNetworksData: async () => {
        ...
        const approvedCaipNetworkIds = WcHelpersUtil.getChainsFromNamespaces((_a2 = provider.session) == null ? void 0 : _a2.namespaces);
        return Promise.resolve({
          supportsAllNetworks: false,
          approvedCaipNetworkIds
        });
    ...
    this.connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        if (ChainController.state.activeChain && ((_c = (_b2 = (_a2 = ChainController.state) == null ? void 0 : _a2.chains) == null ? void 0 : _b2.get(ChainController.state.activeChain)) == null ? void 0 : _c.adapterType) === "wagmi") {
          ...
          if (siweConfig && isSiweEnabled && siweParams && isProviderSupported && isSiweParamsValid && ChainController.state.activeChain === ConstantsUtil.CHAIN.EVM) {
            const { SIWEController, getDidChainId, getDidAddress } = await import("./exports-E6C5YNFW.js");
            const chains = (_h = this.caipNetworks) == null ? void 0 : _h.filter((network) => network.chainNamespace === ConstantsUtil.CHAIN.EVM).map((chain) => chain.caipNetworkId);
            siweParams.chains = (_i = this.caipNetworks) == null ? void 0 : _i.filter((network) => network.chainNamespace === ConstantsUtil.CHAIN.EVM).map((chain) => chain.id);
      ...
      disconnect: async () => {
        ...
        if ((_a2 = siweConfig == null ? void 0 : siweConfig.options) == null ? void 0 : _a2.signOutOnDisconnect) {
          const { SIWEController } = await import("./exports-E6C5YNFW.js");
  ...
  async disconnect() {
    ...
    if (this.walletConnectProvider) {
      ...
      (_a2 = this.appKit) == null ? void 0 : _a2.resetAccount(ConstantsUtil.CHAIN.EVM);
      (_b2 = this.appKit) == null ? void 0 : _b2.resetAccount(ConstantsUtil.CHAIN.SOLANA);
    }
  }
  ...
  createProvider() {
    var _a2, _b2;
    if (!this.walletConnectProviderInitPromise && typeof window !== "undefined" && ((_a2 = this.options) == null ? void 0 : _a2.projectId)) {
      this.walletConnectProviderInitPromise = this.initWalletConnectProvider((_b2 = this.options) == null ? void 0 : _b2.projectId);
    }
  ...
  syncRequestedNetworks(caipNetworks) {
    ...
    uniqueChainNamespaces.filter((c) => Boolean(c)).forEach((chainNamespace) => {
      var _a2;
      (_a2 = this.appKit) == null ? void 0 : _a2.setRequestedCaipNetworks(caipNetworks.filter((caipNetwork) => caipNetwork.chainNamespace === chainNamespace), chainNamespace);
    });
  }
  ...
  setWalletConnectProvider() {
    ...
    const nameSpaces = (_b2 = (_a2 = this.walletConnectProvider) == null ? void 0 : _a2.session) == null ? void 0 : _b2.namespaces;
    if (nameSpaces) {
      const reversedChainNamespaces = Object.keys(nameSpaces).reverse();
      reversedChainNamespaces.forEach((chainNamespace) => {
        var _a3, _b3, _c;
        const caipAddress = (_a3 = nameSpaces == null ? void 0 : nameSpaces[chainNamespace]) == null ? void 0 : _a3.accounts[0];
        ...
        (_b3 = this.appKit) == null ? void 0 : _b3.setApprovedCaipNetworksData(chainNamespace);
        if (caipAddress) {
  ...
  setDefaultNetwork(nameSpaces) {
    var _a2;
    const chainNamespace = (_a2 = this.caipNetworks[0]) == null ? void 0 : _a2.chainNamespace;
    if (chainNamespace) {
  ...
  async watchWalletConnect() {
    var _a2;
    const provider = await this.getWalletConnectProvider();
    const namespaces = ((_a2 = provider == null ? void 0 : provider.session) == null ? void 0 : _a2.namespaces) || {};
    ...
    const chainChanged = (chainId) => {
      ...
      const currentCaipNetwork = (_a3 = this.appKit) == null ? void 0 : _a3.getCaipNetwork();
      if (!caipNetwork) {
        const namespace = ((_b2 = this.appKit) == null ? void 0 : _b2.getActiveChainNamespace()) || ConstantsUtil.CHAIN.EVM;
  ...
  syncAccount() {
    ...
    const preferredAccountType = (_a2 = this.appKit) == null ? void 0 : _a2.getPreferredAccountType();
    const isConnected = ((_b2 = this.appKit) == null ? void 0 : _b2.getIsConnectedState()) || false;
    if (isConnected) {
      namespaceKeys.forEach(async (key) => {
        var _a3, _b3, _c2, _d2, _e;
        const chainNamespace = key;
        const address = (_a3 = namespaces == null ? void 0 : namespaces[key]) == null ? void 0 : _a3.accounts[0];
        const isNamespaceConnected = (_b3 = this.appKit) == null ? void 0 : _b3.getCaipAddress(chainNamespace);
  ...
  syncAccounts(reset = false) {
    ...
    chainNamespaces.forEach((chainNamespace) => {
      var _a2, _b2, _c, _d;
      const addresses = (_b2 = (_a2 = namespaces == null ? void 0 : namespaces[chainNamespace]) == null ? void 0 : _a2.accounts) == null ? void 0 : _b2.map((account) => {
  ...
  syncConnectedWalletInfo() {
    ...
    chainNamespaces.forEach((chainNamespace) => {
      ...
      if ((_a3 = this.walletConnectProvider) == null ? void 0 : _a3.session) {
        (_c = this.appKit) == null ? void 0 : _c.setConnectedWalletInfo({
          ...
          icon: (_b3 = this.walletConnectProvider.session.peer.metadata.icons) == null ? void 0 : _b3[0]
        }, chainNamespace);
...
var AppKit = class {
  constructor(options) {
    ...
    this.getCaipNetwork = (chainNamespace) => {
      var _a3;
      if (chainNamespace) {
        return (_a3 = ChainController.getRequestedCaipNetworks(chainNamespace).filter((c) => c.chainNamespace === chainNamespace)) == null ? void 0 : _a3[0];
      }
  ...
  async initControllers(options) {
    ...
    const evmAdapter = (_a2 = options.adapters) == null ? void 0 : _a2.find((adapter) => adapter.chainNamespace === ConstantsUtil.CHAIN.EVM);
    if (evmAdapter) {
  ...
  setMetadata(options) {
    ...
    options.metadata = {
      name: ((_a2 = document.getElementsByTagName("title")[0]) == null ? void 0 : _a2.textContent) || "",
      description: ((_b2 = document.querySelector('meta[property="og:description"]')) == null ? void 0 : _b2.content) || "",
  ...
  extendDefaultCaipNetwork(options) {
    const defaultNetwork = options.networks.find((n) => {
      var _a2;
      return n.id === ((_a2 = options.defaultNetwork) == null ? void 0 : _a2.id);
    });
  ...
  initializeUniversalAdapter(options) {
    ...
    (_b2 = (_a2 = this.universalAdapter).construct) == null ? void 0 : _b2.call(_a2, this, extendedOptions);
  }
  initializeAdapters(options) {
    ...
    (_a2 = options.adapters) == null ? void 0 : _a2.forEach((adapter) => {
      var _a3;
      (_a3 = adapter.construct) == null ? void 0 : _a3.call(adapter, this, extendedOptions);
    });
  }
  setDefaultNetwork() {
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([
          import("./esm-MWM3WMYV.js"),
          import("./w3m-modal-CGWTUKCV.js")
        ]);
  ...
  constructor() {
    ...
    this.unsubscribe.push(...[
      AssetController.subscribeNetworkImages(() => {
        var _a2, _b2;
        this.networkImage = ((_b2 = (_a2 = this.network) == null ? void 0 : _a2.assets) == null ? void 0 : _b2.imageId) ? AssetUtil.getNetworkImage(this.network) : void 0;
      }),
      ...
      ChainController.subscribeKey("activeCaipNetwork", (val) => {
        var _a2;
        this.network = val;
        this.networkImage = ((_a2 = val == null ? void 0 : val.assets) == null ? void 0 : _a2.imageId) ? AssetUtil.getNetworkImage(val) : void 0;
...
var W3mAccountSettingsView = class W3mAccountSettingsView2 extends LitElement {
  ...
  render() {
    ...
    const networkImage = this.networkImages[((_b2 = (_a2 = this.network) == null ? void 0 : _a2.assets) == null ? void 0 : _b2.imageId) ?? ""];
    return html`
      <wui-flex
...
var W3mConnectView = class W3mConnectView2 extends LitElement {
  ...
  render() {
    var _a2;
    const socials = (_a2 = this.features) == null ? void 0 : _a2.socials;
  ...
  walletListTemplate() {
    var _a2, _b2;
    const socials = (_a2 = this.features) == null ? void 0 : _a2.socials;
    const emailShowWallets = (_b2 = this.features) == null ? void 0 : _b2.emailShowWallets;
    const enableWallets = OptionsController.state.enableWallets;
    if (!enableWallets) {
      return null;
    }
...
var W3mConnectingMultiChainView = class W3mConnectingMultiChainView2 extends LitElement {
  ...
  networksTemplate() {
    var _a2, _b2;
    return (_b2 = (_a2 = this.activeConnector) == null ? void 0 : _a2.connectors) == null ? void 0 : _b2.map((connector) => connector.name ? html`
            <wui-list-wallet
  ...
  onConnector(provider) {
    var _a2, _b2;
    const connector = (_b2 = (_a2 = this.activeConnector) == null ? void 0 : _a2.connectors) == null ? void 0 : _b2.find((p) => p.chain === provider.chain);
    if (!connector) {
...
var W3mNetworksView = class W3mNetworksView2 extends LitElement {
  ...
  onSwitchNetwork(network) {
    ...
    const isSameNetwork = network.id === ((_a2 = this.network) == null ? void 0 : _a2.id);
    if (isSameNetwork) {
      return;
    }
...
var W3mSwapView = class W3mSwapView2 extends LitElement {
  constructor() {
    ...
    this.caipNetworkId = (_a2 = ChainController.state.activeCaipNetwork) == null ? void 0 : _a2.caipNetworkId;
...
var W3mWalletReceiveView = class W3mWalletReceiveView2 extends LitElement {
  ...
  networkTemplate() {
    ...
    const slicedNetworks = (_a2 = requestedCaipNetworks == null ? void 0 : requestedCaipNetworks.filter((network) => {
      var _a3;
      return (_a3 = network == null ? void 0 : network.assets) == null ? void 0 : _a3.imageId;
    })) == null ? void 0 : _a2.slice(0, 5);
...
var W3mSendSelectTokenView = class W3mSendSelectTokenView2 extends LitElement {
  ...
  templateTokens() {
    ...
    this.tokens = (_a2 = this.tokenBalance) == null ? void 0 : _a2.filter((token) => {
      var _a3;
      return token.chainId === ((_a3 = ChainController.state.activeCaipNetwork) == null ? void 0 : _a3.caipNetworkId);
    });
    if (this.search) {
...
var W3mSwitchAddressView = class W3mSwitchAddressView2 extends LitElement {
  ...
  connectedCallback() {
    ...
    this.allAccounts.forEach((account) => {
      var _a2;
      BlockchainApiController.getBalance(account.address, (_a2 = this.caipNetwork) == null ? void 0 : _a2.caipNetworkId).then((response) => {
...
var WuiSwapDetails = class WuiSwapDetails2 extends LitElement {
  constructor() {
    ...
    super();
    this.unsubscribe = [];
    this.networkName = (_a2 = ChainController.state.activeCaipNetwork) == null ? void 0 : _a2.name;
    this.detailsOpen = false;
    this.sourceToken = SwapController.state.sourceToken;
    this.toToken = SwapController.state.toToken;
    this.toTokenAmount = SwapController.state.toTokenAmount;
...
var W3mEmailLoginWidget = class W3mEmailLoginWidget2 extends LitElement {
  ...
  render() {
    var _a2;
    const email = (_a2 = OptionsController.state.features) == null ? void 0 : _a2.email;
  ...
  separatorTemplate() {
    var _a2, _b2;
    const socials = (_a2 = OptionsController.state.features) == null ? void 0 : _a2.socials;
    const multipleConnectors = this.connectors.length > 1;
    const enableWallets = OptionsController.state.enableWallets;
    const emailShowWallets = (_b2 = OptionsController.state.features) == null ? void 0 : _b2.emailShowWallets;
...
W3mEmailLoginWidget = __decorate80([
...
var W3mAccountDefaultWidget = class W3mAccountDefaultWidget2 extends LitElement {
  ...
  onrampTemplate() {
    var _a2;
    const onramp = (_a2 = this.features) == null ? void 0 : _a2.onramp;
    if (!onramp) {
      return null;
    }
    return html`
  ...
  swapsTemplate() {
    var _a2;
    const swaps = (_a2 = this.features) == null ? void 0 : _a2.swaps;
    const isSolana = ChainController.state.activeChain === ConstantsUtil.CHAIN.SOLANA;
    if (!swaps || isSolana) {
      return null;
    }
...
W3mAccountDefaultWidget = __decorate81([
...
var W3mAccountWalletFeaturesWidget = class W3mAccountWalletFeaturesWidget2 extends LitElement {
  ...
  onSwapClick() {
    var _a2, _b2, _c;
    if (((_a2 = this.network) == null ? void 0 : _a2.caipNetworkId) && !ConstantsUtil2.SWAP_SUPPORTED_NETWORKS.includes((_b2 = this.network) == null ? void 0 : _b2.caipNetworkId)) {
  ...
  onSendClick() {
    ...
    EventsController.sendEvent({
      ...
      event: "OPEN_SEND",
      properties: {
        network: ((_a2 = this.network) == null ? void 0 : _a2.caipNetworkId) || "",
        isSmartAccount: AccountController.state.preferredAccountType === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    });
...
W3mAccountWalletFeaturesWidget = __decorate82([
...
W3mAccountActivityWidget = __decorate83([
...
W3mAccountNftsWidget = __decorate84([
...
W3mAccountTokensWidget = __decorate85([
...
var W3mActivityList = class W3mActivityList2 extends LitElement {
  ...
  updateTransactionView() {
    var _a2;
    const currentNetwork = (_a2 = ChainController.state.activeCaipNetwork) == null ? void 0 : _a2.caipNetworkId;
...
W3mWalletSendDetails = __decorate89([
...
WuiTooltipTrigger = __decorate91([
...
W3mSocialLoginWidget = __decorate92([
...
W3mWalletLoginList = __decorate93([
...
W3mSocialLoginList = __decorate94([
...
W3mConnectAnnouncedWidget = __decorate95([
...
W3mConnectCustomWidget = __decorate96([
...
W3mConnectFeaturedWidget = __decorate97([
...
W3mConnectInjectedWidget = __decorate98([
...
W3mConnectMultiChainWidget = __decorate99([
...
W3mConnectExternalWidget = __decorate100([
...
W3mConnectRecentWidget = __decorate101([
...
W3mConnectRecommendedWidget = __decorate102([
...
W3mConnectWalletConnectWidget = __decorate103([
...
W3mConnectorList = __decorate104([
...
W3mAllWalletsWidget = __decorate105([
...
W3mAccountAuthButton = __decorate106([
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MCJB4MRO.js.map
