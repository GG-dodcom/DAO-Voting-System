...
import {
  ...
  SocialProviderEnum,
  defaultConfig
} from "./chunk-76NDF6PV.js";
import "./chunk-PQGUMBW7.js";
import {
  AccountController,
  ApiController,
  AssetController,
...
import "./chunk-GEDHPJLK.js";
import "./chunk-5NADXRRG.js";
  ...
  async initControllers(options) {
    ...
    if (evmAdapter) {
      if (options.siweConfig) {
        const { SIWEController } = await import("./exports-COLM2DM3.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-BQDNLIBY.js"), import("./w3m-modal-6KV536VJ.js")]);
