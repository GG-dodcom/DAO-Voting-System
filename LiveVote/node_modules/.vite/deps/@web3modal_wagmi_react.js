...
import {
  ...
  setColorTheme,
  setThemeVariables
} from "./chunk-PFV6CYR2.js";
import {
  ConstantsUtil,
  EVMWagmiClient,
  SocialProviderEnum,
  defaultConfig
} from "./chunk-SGYC57NQ.js";
import {
  AccountController,
  ApiController,
  AssetController,
  ...
  async initControllers(options) {
    ...
    if (evmAdapter) {
      if (options.siweConfig) {
        const { SIWEController } = await import("./exports-E7KFWSRH.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-G7OKQY53.js"), import("./w3m-modal-PEQJVGTQ.js")]);
