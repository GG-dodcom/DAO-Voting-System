...
import {
  ...
  setColorTheme,
  setThemeVariables
} from "./chunk-5FSH77AE.js";
import {
  ConstantsUtil,
  EVMWagmiClient,
  SocialProviderEnum,
  defaultConfig
} from "./chunk-SGD224KF.js";
import {
  AccountController,
  ApiController,
  AssetController,
  ...
  async initControllers(options) {
    ...
    if (evmAdapter) {
      if (options.siweConfig) {
        const { SIWEController } = await import("./exports-BVZ7LTUH.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-NPHSH7ZA.js"), import("./w3m-modal-IVQXY3VI.js")]);
