...
import {
  ...
  setColorTheme,
  setThemeVariables
} from "./chunk-3TUED7X7.js";
import {
  ConstantsUtil,
  EVMWagmiClient,
  SocialProviderEnum,
  defaultConfig
} from "./chunk-HMEVBZCZ.js";
import {
  AccountController,
  ApiController,
  AssetController,
  ...
  async initControllers(options) {
    ...
    if (evmAdapter) {
      if (options.siweConfig) {
        const { SIWEController } = await import("./exports-M3DED42Y.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-MAZE3BJA.js"), import("./w3m-modal-CVP5GUHU.js")]);
