...
} from "./chunk-ER5K2CA2.js";
import "./chunk-IBULWAFU.js";
import "./chunk-LNJ5BZLC.js";
  ...
  async initControllers(options) {
    ...
    if (evmAdapter) {
      if (options.siweConfig) {
        const { SIWEController } = await import("./exports-VVWEKF7L.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-X32LIZDQ.js"), import("./w3m-modal-5357O4C3.js")]);
